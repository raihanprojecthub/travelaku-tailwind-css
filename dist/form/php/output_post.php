  ...
  <section id="invoice" class="pt-36 pb-32">
    <div class="container mx-auto">
      <div class="w-full border rounded-lg shadow-lg lg:w-1/2 px-6 py-8 overflow-x-auto mx-auto">
        ...
        <h1 class="font-bold mb-2 text-xl text-dark lg:text-2xl"><?php $mt_rand = mt_rand(1000000000000000, 9999999999999999);
                                                                  echo $mt_rand; ?></h1>
        <table class="mb-4 w-full mx-auto" cellpadding="5" cellspacing="0">
          <tr>
            <td class="text-left">Invoice</td>
            <td class="text-right"><?php $mt_rand2 = mt_rand(1000000000000000, 9999999999999999);
                                    echo $mt_rand2 ?></td>
          </tr>
          <tr>
